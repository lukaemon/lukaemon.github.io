...
Multimodal is on fire. One big end to end model may be enough, `Gato` (@reedGeneralistAgent2022). On the other hand, modular approach with glue architecture may work, `Flamingo` (@alayracFlamingoVisualLanguage2022), `RETRO`. It's great to be alive in this era of AI.
